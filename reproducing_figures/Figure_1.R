...
##################################################################################################
### Figure 1. A single-cell chromatin-accessibility timelapse of mouse development from E10 to P0.

########################################################################################
### Fig. 1b: The log2 scaled number of cells profiled per embryo, sorted by staging bin.
...
##########################################################################################################
### Fig. 1c: Embeddings of pseudo-bulk ATAC-seq profiles of 36 embryos in PCA space, plotting PC1 vs. PC2.
...
##################################################################################################################
### Fig. 1d: 3D UMAP visualization of co-embedded cells from published scRNA-seq and scATAC-seq (this study) data.
...
#####################################################################################################################################################################################################################
### Fig. 1e: For scATAC-seq cells from each staging bin (x-axis), the density of staging-bins-of-origin of their nearest scRNA-seq derived neighbors (n = 10) in the scGLUE-derived co-embedding is plotted (y-axis).
