...
Distribution of mean phyloP scores (60 placental mammals), computed by averaging nucleotide-level scores within each element.


```{code-cell #Fig5b_phyloP_distribution} r
...
Relationship between cell-class-specific enhancer prediction scores vs. cell-class-specific expression of nearby genes.


```{code-cell #Fig5d_predict_gene_exp} r
web_path = "https://shendure-web.gs.washington.edu/content/members/cxqiu/public/backup/jax_atac/download/reproducing_figures"
