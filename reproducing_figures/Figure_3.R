...
#################################################################################################
### Figure 3. Evolution-naive modeling of chromatin accessibility across 36 Level-2 cell classes.

########################################################################################################################################################################################################################################################################
### Fig. 3b: Scatterplots of observed (normalized Tn5 cut-site counts; natural log-scaled; x-axis) vs. predicted (evolution-naive CREsted model; natural log-scaled; y-axis) chromatin accessibility across across 9,583 held-out peaks for all 36 Level-2 cell classes.
...
###########################################################################################################################################################################################################################
### Fig. 3c: Pairwise Pearson correlations were computed across 36 Level-2 cell classes between normalized Tn5 cut-site counts from scATAC-seq data (rows) and CREsted model predictions (columns) at 9,583 held-out peaks.
...
##################################################################################################################################################################################
### Fig. 3d: Observed (top) and predicted (bottom) chromatin accessibility is plotted for each of the 36 Level-2 cell classes, for three representative regions from the test set.
...
################################################################################################################################################################################################################################################################################################################################################################
### Fig. 3e: Pairwise overlaps (bp) between 100 bp windows with high predicted accessibility and specificity (both a Z-transformed predicted score ≥ 3 and a Z-transformed specificity ≥ 3; rows) and the top 10,000 specific peaks used for training (columns) across all 36 Level-2 cell classes, normalized by the total size of each class’s training peaks.
...
######################################################################################################################################################################################################################################################################################################
### Fig. 3g: Scatterplots of observed (normalized Tn5 cut-site counts; natural log-scaled; x-axis) vs. predicted (evolution-naive CREsted model; natural log-scaled; y-axis) chromatin accessibility across 1.25 million x 100 bp windows spanning mouse chromosome 9 for all 36 Level-2 cell classes.
...
########################################################################################################################################################################################################################################################################################
### Fig. 3h: A plot similar to panel g, but instead of coloring each bin by the counts of 100 bp windows, it is colored by the difference between the percentage of windows overlapping tandem repeats and the percentage overlapping promoters (−1,500 bp to +500 bp relative to TSSs).
